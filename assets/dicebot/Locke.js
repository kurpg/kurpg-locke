...
(function (Opal) {
  ...
  Opal.add_stubs(['$get_damage', '$!', '$nil?', '$get_ship_attack', '$get_shoot_attack', '$get_effect', '$[]', '$upcase', '$===', '$get_table_by_1d6', '$get_table_by_2d6', '$get_ship_attack_normal', '$get_ship_attack_black_maiden', '$get_ship_attack_mouse', '$roll_nd6', '$==', '$<=', '$get_arrival_check', '$get_revival_check', '$get_zanryu_shinen_check', '$to_i', '$last_match', '$get_jail_check', '$get_transformation_check', '$get_t13_effect', '$get_t14_effect', '$get_geoid_character', '$get_geoid_item', '$get_hyperspace_beam', '$get_plug_effect', '$+', '$>=', '$>', '$each', '$-', '$roll', '$getDiceListFromDiceText', '$get_table_by_nd6', '$setPrefixes', '$keys', '$debug', '$=~', '$collect', '$split']);
  return (function ($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Locke');

    var $nesting = [self].concat($parent_nesting), $Locke_initialize$1, $Locke_rollDiceCommand$2, $Locke_get_ship_attack$3, $Locke_get_ship_attack_normal$4, $Locke_get_ship_attack_black_maiden$5, $Locke_get_ship_attack_mouse$6, $Locke_get_effect$7, $Locke_get_arrival_check$8, $Locke_get_revival_check$9, $Locke_get_zanryu_shinen_check$10, $Locke_get_transformation_check$11, $Locke_get_jail_check$12, $Locke_get_plug_effect$13, $Locke_get_t13_effect$14, $Locke_get_t14_effect$15, $Locke_get_geoid_character$16, $Locke_get_geoid_item$17, $Locke_get_hyperspace_beam$18, $Locke_get_shoot_attack$19, $Locke_get_damage$21, $Locke_roll_nd6$22, $Locke_get_table_by_nd6$23, $Locke_get_table_by_2d6$24, $Locke_get_table_by_1d6$25, $a, $Locke_getDiceList$26, $Locke_getDiceListFromDiceText$27;

    self.$$prototype.diceText = nil;

    Opal.const_set($nesting[0], 'ID', "Locke");
    Opal.const_set($nesting[0], 'NAME', "超人ロック");
    Opal.const_set($nesting[0], 'SORT_KEY', "ちょうしんろつく");

    Opal.def(self, '$initialize', $Locke_initialize$1 = function $$initialize() {
      var $iter = $Locke_initialize$1.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) $Locke_initialize$1.$$p = null;
      // Prepare super implicit arguments
      for ($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }

      $send(self, Opal.find_super_dispatcher(self, 'initialize', $Locke_initialize$1, false), $zuper, $iter);
      return (self.sendMode = 2);
    }, $Locke_initialize$1.$$arity = 0);
    Opal.const_set($nesting[0], 'HELP_MESSAGE', "" + "ARR そこに居たチェック\n" + "REV 実は生きていたチェック\n" + "ZS 残留思念チェック\n" + "\n" + "JAILn 逮捕チェック (出目+n)\n" + "BTL 戦闘チャート\n" + "WPN 武器決定チャート\n" + "\n" + "SHIP 船\n" + "SHIP_BM ブラックメイデン\n" + "SHIP_MS マウス\n" + "\n" + "nRG レイガン  n:攻撃回数（以下同様）\n" + "nBL ブラスター\n" + "nBZ バズーカ\n" + "nBC ビームキャノン\n" + "\n" + "GEO ジオイド弾 (キャラクター)\n" + "IGEO ジオイド弾 (アイテム)\n" + "HYB 亜空間ビーム\n" + "\n" + "DMGn n:1 のダメージ (n = 0 のときは 1:2 のダメージ)\n" + "\n" + "Tn トラップn\n" + "T1-3 トラップ1-3\n" + "T1-4 トラップ1-4\n" + "\n" + "GENE 遺伝子再編成\n" + "PLUG プラグチェック\n" + "RA ランダムアクシデント\n" + "TF 変身チェック\n" + "\n" + "MNS 大臣の特権\n");

    Opal.def(self, '$rollDiceCommand', $Locke_rollDiceCommand$2 = function $$rollDiceCommand(command) {
      ...
      info = (($a = $nesting[0].$$cvars['@@tables']) == null ? nil : $a)['$[]'](command.$upcase());
      if ($truthy(info['$nil?']())) {
        return nil
      };
      name = info['$[]']("name");
      ...
      })(), $a = Opal.to_ary($b), (value = ($a[0] == null ? nil : $a[0])), (num = ($a[1] == null ? nil : $a[1])), (dice_text = ($a[2] == null ? nil : $a[2])), $b;
      result_text = "" + (name) + " (" + (num) + "[" + (dice_text) + "]) → " + (value);
      return result_text;
    }, $Locke_rollDiceCommand$2.$$arity = 1);

    Opal.def(self, '$get_ship_attack', $Locke_get_ship_attack$3 = function $$get_ship_attack(command) {
      ...
      return result_text;
    }, $Locke_get_ship_attack$3.$$arity = 1);

    Opal.def(self, '$get_ship_attack_normal', $Locke_get_ship_attack_normal$4 = function $$get_ship_attack_normal() {
    ...
    }, $Locke_get_ship_attack_normal$4.$$arity = 0);

    Opal.def(self, '$get_ship_attack_black_maiden', $Locke_get_ship_attack_black_maiden$5 = function $$get_ship_attack_black_maiden() {
      var $a, $b, self = this, num = nil, dice_text = nil, attack_text = nil;
    ...
    }, $Locke_get_ship_attack_black_maiden$5.$$arity = 0);

    Opal.def(self, '$get_ship_attack_mouse', $Locke_get_ship_attack_mouse$6 = function $$get_ship_attack_mouse() {
      var $a, $b, self = this, num = nil, dice_text = nil, attack_text = nil;
    ...
    }, $Locke_get_ship_attack_mouse$6.$$arity = 0);

    Opal.def(self, '$get_effect', $Locke_get_effect$7 = function $$get_effect(command) {
      ...
      if ("ARR"['$===']($case)) { result_text = self.$get_arrival_check() }
        ...
        n = ($truthy($a = $$($nesting, 'Regexp').$last_match(1)) ? $a : 0).$to_i();
      ...
      return result_text;
    }, $Locke_get_effect$7.$$arity = 1);

    Opal.def(self, '$get_arrival_check', $Locke_get_arrival_check$8 = function $$get_arrival_check() {
    ...
    }, $Locke_get_arrival_check$8.$$arity = 0);

    Opal.def(self, '$get_revival_check', $Locke_get_revival_check$9 = function $$get_revival_check() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_revival_check$9.$$arity = 0);

    Opal.def(self, '$get_zanryu_shinen_check', $Locke_get_zanryu_shinen_check$10 = function $$get_zanryu_shinen_check() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_zanryu_shinen_check$10.$$arity = 0);

    Opal.def(self, '$get_transformation_check', $Locke_get_transformation_check$11 = function $$get_transformation_check() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_transformation_check$11.$$arity = 0);

    Opal.def(self, '$get_jail_check', $Locke_get_jail_check$12 = function $$get_jail_check(n) {
      ...
      addition_text = (function () {
        if ($truthy(($truthy($a = $rb_gt(n, 0)) ? $rb_ge(num, 6) : $a))) {
          return "" + " + " + (n)
        } else {
          return ""
        }; return nil;
    ...
    }, $Locke_get_jail_check$12.$$arity = 1);

    Opal.def(self, '$get_plug_effect', $Locke_get_plug_effect$13 = function $$get_plug_effect() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_plug_effect$13.$$arity = 0);

    Opal.def(self, '$get_t13_effect', $Locke_get_t13_effect$14 = function $$get_t13_effect() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_t13_effect$14.$$arity = 0);

    Opal.def(self, '$get_t14_effect', $Locke_get_t14_effect$15 = function $$get_t14_effect() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_t14_effect$15.$$arity = 0);

    Opal.def(self, '$get_geoid_character', $Locke_get_geoid_character$16 = function $$get_geoid_character() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_geoid_character$16.$$arity = 0);

    Opal.def(self, '$get_geoid_item', $Locke_get_geoid_item$17 = function $$get_geoid_item() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
      ...
      return "" + "ジオイド弾 (" + (num) + "[" + (dice_text) + "]) " + (effect_text);
    }, $Locke_get_geoid_item$17.$$arity = 0);

    Opal.def(self, '$get_hyperspace_beam', $Locke_get_hyperspace_beam$18 = function $$get_hyperspace_beam() {
      var $a, $b, self = this, num = nil, dice_text = nil, effect_text = nil;
    ...
    }, $Locke_get_hyperspace_beam$18.$$arity = 0);

    Opal.def(self, '$get_shoot_attack', $Locke_get_shoot_attack$19 = function $$get_shoot_attack(command) {
      var $a, $b, $$20, self = this, weapon_index = nil, weapon_name = nil, $case = nil, count = nil, weapon_damage_table = nil, _ = nil, dice_text = nil, dice_list = nil, shock = nil, dice = nil;
      ...
      count = ($truthy($a = $$($nesting, 'Regexp').$last_match(1)) ? $a : 1).$to_i();
      ...
      ;
      ;
      $send(dice_list, 'each', [], ($$20 = function ($for_tmp1) {
        var self = $$20.$$s || this;
        ...
        dice = $for_tmp1;
        return (shock = $rb_plus(shock, weapon_damage_table['$[]'](weapon_index)['$[]']($rb_minus(dice, 1))));
      }, $$20.$$s = self, $$20.$$arity = 1, $$20));;
      return "" + (weapon_name) + "x" + (count) + " ([" + (dice_text) + "]) → 火力" + (shock);
    }, $Locke_get_shoot_attack$19.$$arity = 1);

    Opal.def(self, '$get_damage', $Locke_get_damage$21 = function $$get_damage(command) {
      ...
      $case = command;
      if (/DMG(\d+)/i['$===']($case)) { damage_index = $$($nesting, 'Regexp').$last_match(1).$to_i() }
      else { return nil };
      damage_rate_text = "";
      if (damage_index['$=='](0)) {
        damage_rate_text = "1:2"
      } else if ($truthy((($a = $rb_le(1, damage_index)) ? $rb_le(damage_index, 10) : $rb_le(1, damage_index)))) {
        damage_rate_text = "" + (damage_index) + ":1"
      } else {
        return nil
      };
      ...
      $b = self.$get_table_by_2d6(damage_rate_table['$[]'](damage_index)), $a = Opal.to_ary($b), (damage = ($a[0] == null ? nil : $a[0])), (num = ($a[1] == null ? nil : $a[1])), (dice_text = ($a[2] == null ? nil : $a[2])), $b;
    ...
    }, $Locke_get_damage$21.$$arity = 1);

    Opal.def(self, '$roll_nd6', $Locke_roll_nd6$22 = function $$roll_nd6(n) {
    ...
    }, $Locke_roll_nd6$22.$$arity = 1);

    Opal.def(self, '$get_table_by_nd6', $Locke_get_table_by_nd6$23 = function $$get_table_by_nd6(count, table) {
    ...
    return (Opal.def(self, '$getDiceListFromDiceText', $Locke_getDiceListFromDiceText$27 = function $$getDiceListFromDiceText(diceText) {
      ...
      return diceList;
    }, $Locke_getDiceListFromDiceText$27.$$arity = 1), nil) && 'getDiceListFromDiceText';
